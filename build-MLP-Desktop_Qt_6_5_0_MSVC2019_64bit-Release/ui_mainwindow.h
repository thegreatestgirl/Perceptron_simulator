...
"background-color: #1a1d1b;"));
        ...
        graphicsView->setGeometry(QRect(380, 30, 400, 400));
...
"border-radius: 5px;"));
        ...
        clear_graphics_view_button->setObjectName("clear_graphics_view_button");
        clear_graphics_view_button->setGeometry(QRect(369, 440, 201, 41));
...
"border-radius: 5px;"));
        ...
        make_a_guess_button->setObjectName("make_a_guess_button");
        make_a_guess_button->setGeometry(QRect(589, 490, 201, 41));
...
"border-radius: 5px;"));
        ...
        answer->setGeometry(QRect(870, 30, 400, 400));
...
"font-size: 300px;"));
        ...
        load_network_button->setObjectName("load_network_button");
        load_network_button->setGeometry(QRect(10, 270, 161, 41));
...
"border-radius: 5px;"));
        ...
        hidden_layers_quantity->setObjectName("hidden_layers_quantity");
        hidden_layers_quantity->setGeometry(QRect(230, 50, 42, 22));
        ...
        create_network_button->setObjectName("create_network_button");
        create_network_button->setGeometry(QRect(10, 220, 161, 41));
...
"border-radius: 5px;"));
        ...
        matrix_network->setObjectName("matrix_network");
        matrix_network->setGeometry(QRect(10, 70, 111, 20));
        matrix_network->setChecked(true);
        graph_network = new QRadioButton(centralwidget);
        graph_network->setObjectName("graph_network");
        graph_network->setGeometry(QRect(130, 70, 99, 20));
        train_net = new QPushButton(centralwidget);
        train_net->setObjectName("train_net");
        train_net->setGeometry(QRect(190, 220, 161, 41));
...
"border-radius: 5px;"));
        ...
        load_bmp->setObjectName("load_bmp");
        load_bmp->setGeometry(QRect(590, 440, 201, 41));
...
"border-radius: 5px;"));
        ...
        epoch_quantity->setObjectName("epoch_quantity");
        epoch_quantity->setGeometry(QRect(210, 150, 42, 22));
        epoch_quantity->setMinimum(1);
        epoch_quantity->setMaximum(1000);
        label_3 = new QLabel(centralwidget);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(10, 150, 191, 16));
        part_of_test = new QDoubleSpinBox(centralwidget);
        part_of_test->setObjectName("part_of_test");
        part_of_test->setGeometry(QRect(200, 450, 62, 22));
        ...
        label_4->setGeometry(QRect(10, 450, 181, 16));
        test_net = new QPushButton(centralwidget);
        test_net->setObjectName("test_net");
        test_net->setGeometry(QRect(10, 490, 231, 41));
...
"border-radius: 5px;"));
        ...
        answer_probability->setObjectName("answer_probability");
        answer_probability->setGeometry(QRect(870, 440, 400, 91));
...
"font-size: 30px;"));
        ...
        save_net->setObjectName("save_net");
        save_net->setGeometry(QRect(190, 270, 161, 41));
...
"border-radius: 5px;"));
        ...
        label->setGeometry(QRect(925, 40, 290, 16));
        label_5 = new QLabel(centralwidget);
        label_5->setObjectName("label_5");
        label_5->setGeometry(QRect(10, 30, 271, 16));
        output_classes_quantity = new QSpinBox(centralwidget);
        output_classes_quantity->setObjectName("output_classes_quantity");
        output_classes_quantity->setGeometry(QRect(280, 30, 42, 22));
        ...
        train_on_img->setObjectName("train_on_img");
        train_on_img->setGeometry(QRect(370, 490, 201, 41));
...
"border-radius: 5px;"));
        ...
        label_6->setGeometry(QRect(370, 540, 201, 16));
        right_class_number = new QSpinBox(centralwidget);
        right_class_number->setObjectName("right_class_number");
        right_class_number->setGeometry(QRect(580, 540, 42, 22));
